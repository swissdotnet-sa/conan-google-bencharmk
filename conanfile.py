...
class GoogleBenchmarkConan(ConanFile):
    ...
    _build_subfolder = "benchmark"

    def source(self):
        self.run("git clone https://github.com/google/benchmark.git")
        cdAndGitCheckoutCmd = "cd " + self.name + " && git checkout v" + self.version
        self.run(cdAndGitCheckoutCmd)
    ...
    def _configure_cmake(self):
        ...
        cmake.configure(source_dir=self._build_subfolder)
        return cmake
